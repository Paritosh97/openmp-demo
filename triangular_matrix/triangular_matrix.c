  ...
  void mult_mat_vector_tri_inf1 (matrix M, vector b, vector c)
  {
    ...
    */
    ...
    #pragma omp parallel shared(M,b,c) 
    {
      int r;
  ...
  */
  ...
  int main ()  
  {
    ...
    */
    ...
    printf ("Parallel Loop Static Scheduling Speedup \t\t  %f \n", serialExec/(av-residu)) ;
    ...
    */
    ...
    printf ("Parallel Loop Dynamic Scheduling Speedup \t\t  %f \n", serialExec/(av-residu)) ;
    ...
    */
    ...
    printf ("Parallel Loop Guided Scheduling Speedup \t\t  %f \n", serialExec/(av-residu)) ;
    ...
    */
    ...
    printf ("Parallel Loop Runtime Scheduling Speedup \t\t  %f \n", serialExec/(av-residu)) ;
